...
<button type="button" style="color: #fff" class="btn btn-lg {'current' if current_path in ('/support/', '/contact/') else 'heffect'} text-start shadow-none" data-bs-toggle="offcanvas" data-bs-target="#info-sidebar" aria-controls="info-sidebarlabel"><span class="bi-info-lg"></span> Info<span class="bi-arrow-return-right float-end"></span></button>
...
<div class="offcanvas offcanvas-start" style="background-color: #272727;" tabindex="-1" id="images-sidebar" data-bs-scroll="false" data-bs-backdrop="false" aria-labelledby="images-sidebarlabel" aria-modal="true" role="dialog">
    ...
    <div class="offcanvas-body">
        <div class="d-grid gap-2">
            <a type="button" href="/random/?is_nsfw=on" style="color: #fff" class="btn btn-lg {'current' if current_path == '/nsfw/ero/' else 'heffect'} text-start shadow-none"><span class="bi-exclamation-lg"></span> NSFW</a>
